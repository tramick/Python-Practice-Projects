...
# Display the intro:
print('''Birthday Paradox, by Thomas Amick (based on a program by Al Swiegart)

The Birthday Paradox shoes us that in a group of N people, the odds
...
simMatch = 0 #how many simulations had mathcing birthdays in them.
